...
//        if (mId != -1) {
//            PasswordData passwordData = DbManager.getInstance().queryById(mId);
//            updateViews(passwordData);
//        }
//    }
//
//    @Override
...
//    }
//
//    private void updateViews(PasswordData passwordData) {
//        mTvTitle.setText(passwordData.getAddress());
//        mTvName.setText("用户名：" + passwordData.getName());
//        mTvPassword.setText("密  码：" + passwordData.getPwd());
////        mSmartRecycleView.handleData(passwordData.getUpdateHistorys());
//    }
//
